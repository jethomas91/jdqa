...
{3} times in {4} trials while chance would be the cause and effect in {5} time{6} in {4} trials."; } }
        ...
        public static string PointZeroZeroOneStatement { get { return String.Format(StatementTemplate, 'n', "very high", "0.001", "999", "1000", "1", ""); } }

        public static  string PointZeroOneStatement { get { return String.Format(StatementTemplate, "", "high", "0.01", "99", "100", "1", ""); } }

        public static  string PointZeroFiveStatement { get { return String.Format(StatementTemplate, "", "strong", "0.05", "95", "100", "5", "s"); } }
