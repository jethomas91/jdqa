...
namespace JDQA.Classes
{
    ...
    public class ConvertedScoreTable {
        ...
        private void initializeTable() {
            ...
            ConversionRows[67] = new ConvertedScoreRow(48,74);
            ConversionRows[68] = new ConvertedScoreRow(47,74);
            ConversionRows[69] = new ConvertedScoreRow(46,75);
            ConversionRows[70] = new ConvertedScoreRow(46,75);
            ConversionRows[71] = new ConvertedScoreRow(45,75);
            ConversionRows[72] = new ConvertedScoreRow(44,76);
            ConversionRows[73] = new ConvertedScoreRow(43,76);
            ConversionRows[74] = new ConvertedScoreRow(42,77);
            ConversionRows[75] = new ConvertedScoreRow(41,77);
            ConversionRows[76] = new ConvertedScoreRow(41,78);
            ConversionRows[77] = new ConvertedScoreRow(40,78);
            ConversionRows[78] = new ConvertedScoreRow(39,79);
            ConversionRows[79] = new ConvertedScoreRow(38,79);
            ConversionRows[80] = new ConvertedScoreRow(37,80);
            ConversionRows[81] = new ConvertedScoreRow(36,80);
            ConversionRows[82] = new ConvertedScoreRow(35,81);
            ConversionRows[83] = new ConvertedScoreRow(34,81);
            ConversionRows[84] = new ConvertedScoreRow(33,82);
            ConversionRows[85] = new ConvertedScoreRow(32,83);
            ConversionRows[86] = new ConvertedScoreRow(31,83);
            ConversionRows[87] = new ConvertedScoreRow(30,84);
            ConversionRows[88] = new ConvertedScoreRow(28,84);
            ConversionRows[89] = new ConvertedScoreRow(27,85);
            ConversionRows[90] = new ConvertedScoreRow(26,86);
            ConversionRows[91] = new ConvertedScoreRow(25,86);
            ConversionRows[92] = new ConvertedScoreRow(23,87);
            ConversionRows[93] = new ConvertedScoreRow(22,88);
            ConversionRows[94] = new ConvertedScoreRow(20,89);
            ConversionRows[95] = new ConvertedScoreRow(18,90);
            ConversionRows[96] = new ConvertedScoreRow(16,91);
            ConversionRows[97] = new ConvertedScoreRow(14,92);
            ConversionRows[98] = new ConvertedScoreRow(11,94);
            ConversionRows[99] = new ConvertedScoreRow(8,96);
